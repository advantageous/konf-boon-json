...
public class BoonConfigLoaderTest {


    private Config config;

    @Test
    public void testLaxJson() {
    ...
    public void setUp() throws Exception {
        config = configs(boonConfig("reference.conf"), config("test-config.js"));
    }
    ...
    public void testSimplePath() throws Exception {
        ...
        assertEquals(2.01f, config.getFloat("configInner.float2"), 0.1);
    }
    ...
    public void testGetConfig() throws Exception {
        ...
        assertEquals(2.01f, configInner.getFloat("float2"), 0.1);
    }
    ...
    public void testGetMap() throws Exception {
        ...
        assertTrue(map.containsKey("int2"));
        assertEquals(2, (int) map.get("int2"));
        assertEquals(2.01f, (double) map.get("float2"), 0.001);
    ...
    public void memorySize() {
        ...
        assertEquals(ConfigMemorySize.valueOf("10GB").toBytes(), diskSpace.toBytes());
    }
    ...
    public void memorySizes() {
        ...
        assertEquals(ConfigMemorySize.valueOf("10GB").toBytes(), diskVolumes.get(0).toBytes());
        assertEquals(ConfigMemorySize.valueOf("10GB").toBytes(), diskVolumes.get(1).toBytes());
        assertEquals(ConfigMemorySize.valueOf("10GB").toBytes(), diskVolumes.get(2).toBytes());
        assertEquals(ConfigMemorySize.valueOf("10B").toBytes(), diskVolumes.get(3).toBytes());
    }
